...
public class CellSociety extends Application {
	...
	private Simulation[] possibleSimulations = { 
			new Fire(DEFAULT_GRID_SIZE,myFileReader.getProbCatch()), 
			new GameOfLife(DEFAULT_GRID_SIZE),
			new PredatorPrey(DEFAULT_GRID_SIZE), 
			new Segregation(DEFAULT_GRID_SIZE) };
